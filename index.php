...
<body class="bg-gray-900 text-gray-100 h-screen flex flex-col overflow-hidden" x-data>
    ...
    <div class="flex flex-1 overflow-hidden relative">
        ...
        <aside class="bg-gray-800 border-r border-gray-700 flex flex-col overflow-hidden
            ...
            <!-- Sidebar footer -->
            <div class="p-3 border-t border-gray-700 flex items-center justify-center gap-4 text-xs text-gray-500">
                <a href="https://github.com/vitaliikaplia/aitalks" target="_blank" class="hover:text-gray-300 flex items-center gap-1" title="GitHub">
                ...
                <a href="https://vitaliikaplia.com/" target="_blank" class="hover:text-gray-300 flex items-center gap-1" title="Розробник">
                    <img src="https://vitaliikaplia.com/favicon.ico" alt="" class="w-4 h-4">
                    Vitalii Kaplia
                </a>
            </div>
        </aside>
